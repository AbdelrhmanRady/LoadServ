...
<div class="HomeContainer">
    ...
    <br>
    <h1 style="text-align: center">{{$category->categoryName}} Subcategories </h1>
    ...
    <div class="home-products py-5">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-start">
                ...
                <a href="{{ route("category.subShow", [$category->categoryName, $subcategory]) }}" style="border:  2px solid black; text-align:center; padding:80px 0 80px 0;color:black;text-decoration: none;margin-right:5%" href="https://www.google.com/">
                {{$subcategory}}
                </a>
                @endforeach
            </div>
    ...
    <hr>
    <br>
    <h1 style="text-align: center">{{$category->categoryName}} Products </h1>
